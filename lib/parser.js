...
(function() {
  ...
  exports.Parser = (function(superClass) {
    ...
    Parser.prototype.reset = function() {
      var attrkey, charkey, indexMapping, indexing, indexkey, ontext, stack;
      ...
      indexing = this.options.indexing;
      indexkey = this.options.indexkey;
      indexMapping = {};
      this.saxParser.onopentag = (function(_this) {
        return function(node) {
          var key, newValue, obj, parentTag, processedKey, ref;
          obj = {};
          obj[charkey] = "";
          ...
          if (indexing) {
            if (stack.length > 0) {
              ...
              if (indexMapping[parentTag] !== void 0) {
